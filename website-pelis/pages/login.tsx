  ...
  return ( 
    ...
    {/*LOGO NETFLIX LOGIN*/}
      ...
      <form 
        ...
        className="relative mt-24 space-y-8 rounded bg-black/75 py-10 md:mt-0 md:max-w-md
        md:px-14"
      >
        ...
        <div className="space-y-4">
          <label className="inline-block w-full">
            <input type="email" placeholder="Emal" className="input" 
